...
use fsrs_frontend::ast::{DuTypeDef, Expr, Pattern, TypeDefinition, TypeExpr, VariantDef};
...
fn test_expr_variant_construct_with_field() {
    let expr = Expr::VariantConstruct {
        ...
        variant: "Some".to_string(),
        fields: vec![Box::new(Expr::Lit(fsrs_frontend::ast::Literal::Int(42)))],
    };
...
fn test_expr_variant_construct_with_multiple_fields() {
    let expr = Expr::VariantConstruct {
        ...
        variant: "Rectangle".to_string(),
        fields: vec![
            Box::new(Expr::Lit(fsrs_frontend::ast::Literal::Float(10.0))),
            Box::new(Expr::Lit(fsrs_frontend::ast::Literal::Float(20.0))),
        ],
    };
...
fn test_expr_variant_nested_tuple() {
    let expr = Expr::VariantConstruct {
        ...
        fields: vec![Box::new(Expr::Tuple(vec![
            Expr::Lit(fsrs_frontend::ast::Literal::Float(1.0)),
            Expr::Lit(fsrs_frontend::ast::Literal::Float(2.0)),
        ]))],
    };
