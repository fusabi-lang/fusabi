# Fusabi Phase 2 Feature Workstreams
...
|-------|--------------|--------|
| **Frontend** | `ast.rs`, `parser.rs`, `types.rs` | `fusabi-frontend` |
| **VM** | `value.rs`, `bytecode.rs`, `vm.rs` | `fusabi-vm` |
| **Integration** | `compiler.rs`, `main.rs`, tests | `fusabi-frontend`, `fusabi-demo` |
