# Fusabi Phase 2 Parallelization Guide
...
|-----------|--------------------|-----------------------|
| **Frontend Dev** | `fusabi-frontend/src/` (ast, parser, types, inference) | `fusabi-frontend/src/compiler.rs` (shared) |
| **VM Dev** | `fusabi-vm/src/` (value, bytecode, vm, closure) | - |
| **Integration Dev** | `fusabi-demo/src/`, `tests/`, `examples/` | `fusabi-frontend/src/compiler.rs` (shared) |
