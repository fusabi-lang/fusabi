# Fusabi Phase 1 Parallelization Guide
...
|-----------|------------------|-------|
| Frontend Dev | `fusabi-frontend/src/` | `ast.rs`, `lexer.rs`, `parser.rs`, `compiler.rs` |
| VM Dev | `fusabi-vm/src/` | `value.rs`, `bytecode.rs`, `vm.rs` |
| Integration Dev | `fusabi-demo/src/`, `tests/`, `.github/` | `main.rs`, integration tests, CI config |
